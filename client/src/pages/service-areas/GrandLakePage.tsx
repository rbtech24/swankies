...
const GrandLakePage = () => {
  const areaName = "Grand Lake";
  const state = "Oklahoma";
  const county = "Delaware";
  const cities = ["Jay", "Grove", "Vanity", "Langley", "Ketchum"];
  const attractions = ["Marinas", "State Parks", "Fishing", "Boating", "Water Sports"];
  const services = [
  ...
  const imageUrl = "https://images.pexels.com/photos/5353282/pexels-photo-5353282.jpeg?auto=compress&cs=tinysrgb&w=1280";
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="keywords" content={`mobile detailing, boat detailing, auto detailing, car detailing, ceramic coating, paint correction, ${areaName}, ${cities.join(', ')}, ${county} county`} />
      ...
      <main className="pt-20">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-8">
                ...
                Serving {cities.join(', ')} and surrounding areas in {county} County.
              </p>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <p className="text-lg mb-6 text-gray-300">
                  ...
                  in {areaName}, {state} and surrounding areas in {county} County. Our team of certified detailers brings our 
                  expertise and equipment directly to your location, whether you're at home, work, or the marina.
                </p>
                <p className="text-lg mb-6 text-gray-300">
                  Grand Lake O' the Cherokees is one of Oklahoma's premier destinations for boating and water activities. 
                  Our mobile detailing services ensure your watercraft stays in pristine condition despite exposure to sun, 
                  water, and environmental elements. We bring our expertise directly to your dock or marina.
                </p>
                <p className="text-lg mb-6 text-gray-300">
            ...
            <div className="mb-16">
              <h2 className="font-montserrat font-bold text-3xl mb-8 text-center">
                Popular <span className="text-primary text-shadow-neon">Attractions</span>
              </h2>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                {attractions.map((attraction, index) => (
                  <div key={index} className="bg-card/50 rounded-xl p-4 text-center border border-primary/20">
                    <h3 className="font-bold text-lg text-white">{attraction}</h3>
                  </div>
                ))}
              </div>
            </div>
